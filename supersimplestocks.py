...
class Portfolio(object):
	...
	Methods:
	    ...
	    gbce_calc   = The GBCE all share index
    ...
    def gbce_calc(self,trange):
        ...
        """   
        #Tell the user what is happening
        print "\n>>> Computing GBCE all share index using %s's" \
