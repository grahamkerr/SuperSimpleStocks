...
if __name__ == '__main__':
    ...
    # If we want to instead compute the All Share Index of the GBCE 
    # in the previous 15 mins:
    gbce_asi = tradeport.asi_calc(15.00)
    ...
    # Trying to compute ASI or vwsp on an empty portfolio:
